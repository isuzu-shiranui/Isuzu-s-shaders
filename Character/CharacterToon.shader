...
Shader "ASE/Character/CharacterToon"
{
	Properties
	{
		...
		[Header(Subsurface Scattering (SSS))][KeywordEnum(Simple,Advanced)] _SSSType("SSS Type", Float) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 normalizeResult4_g72 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float dotResult456 = dot( normalizeResult4_g72 , NormalDirection51 );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float2 temp_output_2_0_g82 = _BackSpeedXY;
			float2 Offset516 = ( ( 0.0 - 1 ) * i.viewDir.xy * _BackDepthScale ) + i.uv_texcoord;
			float2 temp_output_1_0_g82 = Offset516;
			float2 panner6_g82 = ( _Time.x * temp_output_2_0_g82 + temp_output_1_0_g82);
			float cos5_g82 = cos( ( _Time.x * (temp_output_2_0_g82).x ) );
			float sin5_g82 = sin( ( _Time.x * (temp_output_2_0_g82).x ) );
			float2 rotator5_g82 = mul( temp_output_1_0_g82 - _BackRotationPosition , float2x2( cos5_g82 , -sin5_g82 , sin5_g82 , cos5_g82 )) + _BackRotationPosition;
			float2 lerpResult10_g82 = lerp( panner6_g82 , rotator5_g82 , _BackScrollRotate);
			float4 temp_output_537_0 = ( tex2D( _Back, lerpResult10_g82 ) * _BackColor );
...
/*ASEBEGIN
Version=16200
7;29;1906;1004;-1666.683;-2213.641;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;454;-1383.236,-1383.571;Float;False;Blinn-Phong Half Vector;-1;;72;91a149ac9d615be429126c95e20753ce;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;525;-4861.883,-1087.443;Float;False;UVMove;-1;;82;b9a7d6c5a9a2543498ef7500c85b9f70;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=870A5A727B298876837B9F466E98F60D27602316