...
Shader "ASE/Character/CharacterToon_Parallax_DistReflex"
{
	...
	SubShader
	{
		...
		{
			float2 temp_output_2_0_g45 = _BaseSpeedXY;
			float2 temp_output_1_0_g45 = v.texcoord.xy;
			float2 panner6_g45 = ( _Time.x * temp_output_2_0_g45 + temp_output_1_0_g45);
			float cos5_g45 = cos( ( _Time.x * (temp_output_2_0_g45).x ) );
			float sin5_g45 = sin( ( _Time.x * (temp_output_2_0_g45).x ) );
			float2 rotator5_g45 = mul( temp_output_1_0_g45 - _BaseRotationPosition , float2x2( cos5_g45 , -sin5_g45 , sin5_g45 , cos5_g45 )) + _BaseRotationPosition;
			float2 lerpResult10_g45 = lerp( panner6_g45 , rotator5_g45 , _BaseScrollRotate);
			float4 tex2DNode135 = tex2Dlod( _Texture, float4( lerpResult10_g45, 0, 1.0) );
		...
		{
			float2 temp_output_2_0_g45 = _BaseSpeedXY;
			float2 temp_output_1_0_g45 = i.uv_texcoord;
			float2 panner6_g45 = ( _Time.x * temp_output_2_0_g45 + temp_output_1_0_g45);
			float cos5_g45 = cos( ( _Time.x * (temp_output_2_0_g45).x ) );
			float sin5_g45 = sin( ( _Time.x * (temp_output_2_0_g45).x ) );
			float2 rotator5_g45 = mul( temp_output_1_0_g45 - _BaseRotationPosition , float2x2( cos5_g45 , -sin5_g45 , sin5_g45 , cos5_g45 )) + _BaseRotationPosition;
			float2 lerpResult10_g45 = lerp( panner6_g45 , rotator5_g45 , _BaseScrollRotate);
			float4 tex2DNode135 = tex2D( _Texture, lerpResult10_g45 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 lerpResult49_g49 = lerp( temp_cast_7 , indirectDiffuse48_g49 , _IndirectDiffuseContribution);
			...
			float3 Lighting436 = saturate( ( ( ( lerpResult31_g49 * ase_lightColor.rgb ) + ( ase_lightColor.a * lerpResult49_g49 * temp_output_30_0_g49 ) ) + ( localShadeSH911_g49 + ( localDecodeHDR8_g49 * 0.02 ) ) ) );
			...
			float3 temp_output_65_0_g49 = (temp_output_23_0_g49).xyz;
			float3 temp_cast_17 = (1.0).xxx;
			float3 indirectNormal20_g49 = temp_output_74_0_g49;
			float2 uv_OcculusionMap333 = i.uv_texcoord;
			Unity_GlossyEnvironmentData g20_g49 = UnityGlossyEnvironmentSetup( temp_output_65_0_g49.x, data.worldViewDir, indirectNormal20_g49, float3(0,0,0));
			float3 indirectSpecular20_g49 = UnityGI_IndirectSpecular( data, ( tex2D( _OcculusionMap, uv_OcculusionMap333 ) * _OcculusionStrength ).r, indirectNormal20_g49, g20_g49 );
			float3 lerpResult67_g49 = lerp( temp_cast_17 , indirectSpecular20_g49 , _IndirectSpecularContribution);
			float3 SpecSmooth435 = ( saturate( ( ( temp_output_40_0_g49 + _HighlightCellOffset ) / ( _HighlightCellSharpness * ( 1.0 - temp_output_65_0_g49 ) ) ) ) + ( lerpResult67_g49 * temp_output_65_0_g49 * pow( temp_output_65_0_g49 , 1.5 ) ) );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 lerpResult33_g50 = lerp( BaseColor66 , ( _EmissionColor * _EmissionIntensity ) , temp_output_2_0_g50);
			float4 Emissive429 = ( lerpResult33_g50 * temp_output_2_0_g50 );
...
/*ASEBEGIN
Version=15900
1927;29;1906;1004;-690.3873;-194.5415;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;134;-1701.858,-1328.607;Float;True;Property;_Back;Back;13;1;[NoScaleOffset];Create;True;0;0;False;0;None;961f70cdbe1e0944fbc16ecafac6716e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;128;-1576.089,-893.3998;Float;True;Property;_Mid;Mid;7;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Parallax Mapping) ;None;84b9734c3266f3440a82eb1ef2ba729c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;57;-3252.559,258.5832;Float;False;1193.978;973.8955;Comment;11;97;335;333;334;14;98;432;433;434;435;436;Custom Toon;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;309;-2083.047,-383.9349;Float;False;UVMove;-1;;45;b9a7d6c5a9a2543498ef7500c85b9f70;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;417;-1158.816,-1773.086;Float;True;Property;_RenderTexture;Render Texture;51;0;Create;True;0;0;False;0;None;5a5f84f787d2b794ea083cf7fc68272e;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;135;-1622.185,-481.2145;Float;True;Property;_Texture;Texture;1;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Texture);None;503a4010ad34d784a9b9c8d4f2eda87f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-3203.484,866.8743;Float;False;Property;_Specular;Specular;32;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;303;-1613.851,-61.1755;Float;True;Property;_Mask;Mask;19;1;[NoScaleOffset];Create;True;0;0;False;0;None;1f51c363aeb8cbd42a135b66ca2d35cd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;97;-3224.484,676.8746;Float;True;Property;_SpecularMap;Specular Map;31;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Specular) ;None;04ccb8951ddc66a4cbb7168422c6c573;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;460;-2688.782,567.2901;Float;True;CustomToon;53;;49;daaa5bd54b5359c4a9af1c581225a900;0;5;40;FLOAT;0;False;74;FLOAT3;0,0,0;False;19;FLOAT;0;False;23;FLOAT4;0,0,0,0;False;24;FLOAT;0;False;2;FLOAT3;72;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;436;-2320.778,635.2745;Float;True;Lighting;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;435;-2317.778,425.2745;Float;True;SpecSmooth;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;209;-1616.733,1522.265;Float;True;EmissiveMask;-1;;50;8475a84330edb2b41933a47e12b3e1d8;0;4;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1684.826,291.4542;Float;False;True;6;Float;IsuzuShader.Editor.CharacterShaderCustomInspector;100;0;CustomLighting;ASE/Character/CharacterToon_Parallax_DistReflex;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;Off;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;TransparentCutout;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;True;0;True;360;255;True;356;255;True;366;0;True;357;0;True;359;0;True;358;0;True;365;0;True;361;0;True;364;0;True;362;0;True;363;True;0;4;10;25;False;0.5;True;0;5;True;354;10;True;347;2;5;False;-1;10;False;-1;0;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;100;;-1;-1;-1;64;0;True;0;0;True;340;-1;0;True;353;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;460;40;434;0
WireConnection;460;74;433;0
WireConnection;460;19;14;0
WireConnection;460;23;432;0
WireConnection;460;24;335;0
WireConnection;202;0;42;0
WireConnection;437;0;322;0
WireConnection;427;0;143;0
WireConnection;69;0;68;0
WireConnection;436;0;460;0
WireConnection;431;0;202;0
WireConnection;73;0;71;0
WireConnection;73;1;69;0
WireConnection;74;0;72;0
WireConnection;74;1;70;0
WireConnection;435;0;460;72
...
ASEEND*/
//CHKSM=B7A841AE58779C9A4AEC6139941A640AA4307040